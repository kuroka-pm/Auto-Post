    ...
    return {
        ...
        "prompt_settings": {
            "writing_guidelines": (
                ...
                "3. **改行と空行を使い分けろ**: 文ごとに改行（\\n）を入れろ。"
                "ブロックの区切りには空行（\\n\\n）を1つ入れろ。"
                "全体を2〜3ブロックに分ける。全文を改行なしの1段落にするな。\n"
                ...
                "□ 改行なしで文がつながっていないか？ → 句点「。」のあとに改行を入れる\n"
                "□ 空行ブロックが3つを超えていないか？ → ブロックを統合して減らす\n"
                "□ テーマが2つ以上混在していないか？ → 1つに絞る\n"
        ...
        "sources": {
            "rss_urls": [
                "https://trends.google.co.jp/trends/trendingsearches/daily/rss?geo=JP&cat=b",
                "https://trends.google.co.jp/trends/trendingsearches/daily/rss?geo=JP&cat=t",
                "https://www.gamebusiness.jp/rss/index.rdf",
            ],
            "blacklist": [
                "ドラマ", "映画", "歌手", "俳優", "声優",
                "アイドル", "芸能", "お笑い", "コンサート", "ライブ", "舞台",
            ],
        },
        "schedule": {

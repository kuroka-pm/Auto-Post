...
| ✍️ AI 投稿生成 | トレンド × ペルソナ × 9種スタイルで投稿文を自動生成（画像 + ALT 対応）|
...
| **ユーモア教訓型** 🆕 | 150-280 | 日常のメタファーで有益情報を包む、笑えて学べる型 |
...
- **エクスポート** — 現在の設定を JSON ファイルに保存（フォルダ選択ダイアログ対応）

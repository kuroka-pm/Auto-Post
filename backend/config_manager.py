...
def get_default_config() -> dict:
    ...
    return {
        ...
        "prompt_settings": {
            ...
            "writing_styles": [
                ...
                },
                {
                    "name": "有益リスト型",
                    "weight": 4,
                    "char_range": "200〜280文字",
                    "description": "まとめ・法則・Tips形式。保存＆RTされやすい。具体的な数字と箇条書きで滞在時間を稼ぐ。",
                    "structure": "【フック（具体的数字＋断言）】→【リスト3〜5項目（・か数字）】→【余韻の一行】",
                    "example": (
                        "400人以上みてきて気づいた、\n"
                        "Xが伸びない人の共通点。\n"
                        "\n"
                ...
                },
                {
                    "name": "逆説インサイト型",
                    "weight": 4,
                    "char_range": "180〜260文字",
                    "description": "常識を否定して再定義する。「〇〇？違う。△△？違う。本当は□□」の否定連鎖パターンで滞在時間を最大化。",
                    "structure": "【通説の提示】→【否定の連鎖2〜3回（違います）】→【真の答え＋具体例】→【余韻】",
                    "example": (
                        "Xが伸びない原因。\n"
                        "\n"
                        "ポストの質？違う。\n"
                ...
                },
                {
                    "name": "問いかけ共感型",
                    "weight": 3,
                    "char_range": "120〜200文字",
                    "description": "読者の体験に寄り添う問いかけでリプライを誘発する。具体的なあるある場面を描写して共感を起爆剤にする。",
                    "structure": "【共感シーン描写（あるあるな体験）】→【問いかけ or 気づき】→【一行の余韻】",
                    "example": (
                        "仕事終わりにヘトヘトで帰って、\n"
                        "1時間かけてポスト作って、\n"
                        "「今日は自信ある」と思って投稿。\n"
        ...
        "post_type": {
            ...
            "type_b_styles": ["共感エピソード", "構造分析", "概念の再定義（独自理論）", "有益リスト型", "逆説インサイト型", "問いかけ共感型"],
        },
        "note_promotion": {
            "articles": [
